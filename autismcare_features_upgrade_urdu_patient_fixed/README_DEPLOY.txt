...
DATA ENCRYPTION
The app encrypts sensitive patient/support data at rest using a key derived from the stable SECRET_KEY. Keep SECRET_KEY unchanged in Render. Optionally set DATA_ENCRYPTION_KEY to a valid Fernet key for explicit key management.
